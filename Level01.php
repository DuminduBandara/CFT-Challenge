...
<?php
  if(isset($_POST['submit'])){
    ...
    if($flag == $flag_entered){
      ...
      $sql = "INSERT INTO marks (user, question, marks) VALUES('$userName', '2','50')";
...
<div class="login">
  <div class="heading">
    ...
    <br>
    <br>
    <center><h1 style="font-family:Times New Roman, Times, seri; font-weight: 900; color: #FFFFFF">LEVEL 01 </h1></center>
    <div class="inside">
      ...
      <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" >
        ...
        <button type="submit" name="submit"  class="float">Submit</button>
         ...
         <!-- <input type"button" class="float1" value="Show Scores!" onClick="go(100);"> -->
               ...
               <center><h4 style="font-family:Times New Roman, Times, seri; font-weight: 900; font-size: 20px; color: #DAF7A6">Hint :- Go to this <a href="Level01.1.php" style="color: #E51010">page</a> :) </h4></center>
        ...
        <div class="row justify-content-end">
          <div class="col-md-3">
            <!--add values here to differ the precentage(use decimal)-->
              <div class="round" data-value="0.00" data-size="200" data-thickness="12">

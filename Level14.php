...
<!-- url blocker -->
 <?php 
  ...
  if(isset($_SESSION["LEVEL"])){
     if(($_SESSION["LEVEL"] == 13) && ( $_SESSION["MARKS"] == 1300)){
       $_SESSION["LEVEL"] = 14;
     }
  ...
  if(isset($_POST['submit'])){
   ...
   $db=mysqli_connect("localhost","root","","registration");
    ...
    if($flag == $flag_entered){
      ...
      $sql = "UPDATE marks set question=15, marks=1400 WHERE user='$userName'";
...
<div class="login">
  <div class="heading">
    ...
    <br>
    <br>
    <center><h1 style="font-family:Times New Roman, Times, seri; font-weight: 900; color: #FFFFFF">LEVEL 14 </h1></center>
    <div class="inside">
      ...
      <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" >
        ...
        <button type="submit" name="submit"  class="float">Submit</button>
         ...
         <center><h4 style="font-family:Times New Roman, Times, seri; font-weight: 900; font-size: 20px; color: #DAF7A6">Hint :- Go to this <a href="Level14.1.php" style="color: #E51010">page</a> :) </h4></center>
        ...
        <div class="row justify-content-end">
          <div class="col-md-3">
            <!--add values here to differ the precentage(use decimal)-->
              <div class="round" data-value="0.91" data-size="200" data-thickness="12">

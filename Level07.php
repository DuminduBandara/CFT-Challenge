...
<!-- url blocker -->
 <?php 
  ...
  if(isset($_SESSION["LEVEL"])){
     if(($_SESSION["LEVEL"] == 6) && ( $_SESSION["MARKS"] == 600)){
       $_SESSION["LEVEL"] = 7;
     }
  ...
  if(isset($_POST['submit'])){
   ...
   $db=mysqli_connect("localhost","root","","registration");
    ...
    if($flag == $flag_entered){
      ...
      $sql = "UPDATE marks set question=8, marks=500 WHERE user='$userName'";
...
<div class="login">
  <div class="heading">
    ...
    <br>
    <br>
    <center><h1 style="font-family:Times New Roman, Times, seri; font-weight: 900; color: #FFFFFF">LEVEL 07 </h1></center>
    <div class="inside">
      ...
      <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" >
        ...
        <button type="submit" name="submit"  class="float">Submit</button>
         ...
         <!-- <input type"button" class="float1" value="Show Scores!" onClick="go(100);"> -->
               ...
               <center><h4 style="font-family:Times New Roman, Times, seri; font-weight: 900; font-size: 20px; color: #DAF7A6">Hint :- Go to this <a href="Level07.1.php" style="color: #E51010">page</a> :) </h4></center>
       
       </form>
 		</div>
  </div> <!-- Find :- As well as the value of the session variable called as "FLAG" the ......  -->
 </div>  <!--ex :- spacex{FLAG} -->
        ...
        <div class="row justify-content-end">
          <div class="col-md-3">
            <!--add values here to differ the precentage(use decimal)-->
              <div class="round" data-value="0.42" data-size="200" data-thickness="12">

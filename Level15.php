...
<!-- url blocker -->
 <?php 
  ...
  if(isset($_SESSION["LEVEL"])){
     if(($_SESSION["LEVEL"] == 14) && ( $_SESSION["MARKS"] == 1400)){
       $_SESSION["LEVEL"] = 15;
     }
  ...
  if(isset($_POST['submit'])){
   ...
   $db=mysqli_connect("localhost","root","","registration");
    ...
    if($flag == $flag_entered){
      ...
      $sql = "UPDATE marks set question='Complete', marks=1500 WHERE user='$userName'";
...
<div class="login">
  <div class="heading">
    ...
    <br>
    <br>
    <center><h1 style="font-family:Times New Roman, Times, seri; font-weight: 900; color: #FFFFFF">LEVEL 15 </h1></center>
    <div class="inside">
        ...
        <div class="row justify-content-end">
          <div class="col-md-3">
            <!--add values here to differ the precentage(use decimal)-->
              <div class="round" data-value="0.98" data-size="200" data-thickness="12">
